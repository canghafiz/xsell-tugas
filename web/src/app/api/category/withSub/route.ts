...
export async function GET() {
    ...
    const backendUrl = new URL("member/category/withSub", baseUrl);
    ...
    try {
        ...
        if (!backendRes.ok) {
            ...
            return NextResponse.json(
                { success: false, code: backendRes.status, error: "Failed to fetch categories" },
        ...
        console.error("Category withSub API error:", msg);
        return NextResponse.json(
